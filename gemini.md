...
- **Branch Business Rules**:
  - `elsanta` is a company/partnership. It has shareholders (`company_Owner`) and distributes profits (`Gedo_Dividends_paied`).
  - `mashala` is entirely owned by the user. It does not have shareholders.
